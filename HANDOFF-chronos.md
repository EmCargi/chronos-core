...
date: 2026-08-16
status: active
test_count: 669 total (incl. +10 sxm1_pullover, +3 sxm1_ingest, +5 guild_ingest, +4 guild_region_ingest, +4 guild_org_ingest, +1 shell_wiring, +9 greeting_hub) = 668 pass, 1 skip, all runnable (2026-08-22)
...
- **Test suite at 669 tests (668 pass, 1 skip, all runnable as of 2026-08-22)** — 25 suites. Both ingest/roster suites isolate the roster DB + staging dirs to tmp_path, so live `data/` is never touched by tests.
